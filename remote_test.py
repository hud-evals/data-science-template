...
## Option B: CLI Evaluation
    ...
    # Run all tasks
    hud eval my-org/data-science-tasks --model gpt-4o --remote

## Option C: Python Script (this file)

    # Upload tasks to platform
    python remote_test.py --upload my-org/data-science-tasks

    # Run all tasks
    python remote_test.py --platform my-org/data-science-tasks --model gpt-4o
...
async def main():
    ...
    parser.add_argument(
        "--upload",
        metavar="SLUG",
        help="Upload tasks to platform (e.g. my-org/data-science-tasks)",
    )
    parser.add_argument(
        "--platform",
        metavar="SLUG",
